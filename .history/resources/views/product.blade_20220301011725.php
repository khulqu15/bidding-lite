            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-8 pb-5 px-5">
                    ...
                    <div class="text-right">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#modal-auction" class="btnm-primary px-5">Start Bid</button>
                    </div>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btnm-primary px-4 py-2">Start Bid</button>
                                </div>
                                </form>
                            </div>
                        </div>

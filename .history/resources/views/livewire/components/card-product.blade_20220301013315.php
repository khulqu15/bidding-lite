<div>
    <div class="card card-product border-0 rounded-lg cursor-point mb-4">
        @if (Auth::check())
        ...
        <div class="body p-4">
            ...
            <button onclick="window.location = '{{ route('product', $product->id) }}'" class="btn viga btnm-primary py-3 px-5 position-absolute" style="left:0; bottom: -16px">Lebih Detail</button>
        </div>
    </div>
</div>
